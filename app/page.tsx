            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-2">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight">
                  Halil İbrahim
                  <br />
                  <span className="text-muted-foreground">Kamacı</span>
                </h1>
              </div>
              ...
              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  ...
                  <span className="text-foreground"> React</span>,<span className="text-foreground"> React Native</span>,
                  and
              ...
              {[
                {
                  ...
                  excerpt: "Exploring LLM APIs and Model Context Protocol to build intelligent, context-aware applications.",
                  date: "Jan 2025",
                  readTime: "6 min",
                },
                {
                  title: "React Native Performance Optimization",
                  excerpt: "Techniques for building pixel-perfect, high-performance mobile applications with React Native.",
                  date: "Dec 2024",
                  readTime: "7 min",
                },
                {
                  title: "Autonomous Systems & Embedded Tech",
                  excerpt: "Journey into C++, computer vision, and autonomous UAV navigation from competition experience.",
                  date: "Nov 2024",
                  readTime: "8 min",
                },
                {
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Link
                    href="mailto:halil.kamaci@icloud.com"
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  { name: "React Docs Contributor", handle: "Open Source", url: "https://github.com/reactjs/tr.react.dev" },
                ].map((social) => (
                  <Link
                    key={social.name}
                    href={social.url}
